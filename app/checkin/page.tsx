...
const WAIVER_CHECKBOX_TEXT =
  "I am at least 18 years old, I have read and agree to the Liability Waiver, Release, Assumption of Risk, and Indemnity Agreement, and I understand that it includes a release of claims for ordinary negligence.";
...
Flags and the optional interactive game activities described in this Agreement are solely organized, produced, and operated by Azazel_ver1.0.0 LLC (“Organizer”).
...
11. Game Rules and Participant Conduct
...
13. No Authorization of Theft or Assaultive Conduct
...
14. Health and Fitness Representation
...
15. Property Damage Responsibility
...
18. Medical Authorization and Costs
...
19. Photo, Video, and Incident Documentation
...
This Agreement is governed by the laws of the State of Florida. Any dispute arising out of or related to this Agreement or the event shall be brought exclusively in the state courts located in the county where the event occurs, or, if jurisdiction exists, the appropriate federal court in Florida.
